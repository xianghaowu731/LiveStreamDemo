...
public class MainActivity extends AppCompatActivity implements ConnectCheckerRtmp, SurfaceHolder.Callback,
    ...
    @BindView(R.id.b_start_stop)   Button bStartStop;
    @SuppressLint("NonConstantResourceId")
    ...
    //options menu
    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.activity_custom) DrawerLayout drawerLayout;
    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.nv_rtp) NavigationView navigationView;
    ...
    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.tv_bitrate) TextView tvBitrate;
    ...
    private void prepareOptionsMenuViews() {
        ...
        actionBarDrawerToggle = new ActionBarDrawerToggle(this, drawerLayout, R.string.rtmp_streamer, R.string.rtmp_streamer) {
        ...
        etWowzaPassword = (EditText) navigationView.getMenu().findItem(R.id.et_password).getActionView();
    }
    ...
    public void onConnectionFailedRtmp(final String reason) {
        runOnUiThread(() -> {
            ...
            if (rtmpCamera1.isRecording()) {
                rtmpCamera1.stopRecord();
                bRecord.setText("start_record");
                Toast.makeText(MainActivity.this,"file " + currentDateAndTime + ".mp4 saved in " + folder.getAbsolutePath(),Toast.LENGTH_SHORT).show();
                currentDateAndTime = "";
            }
        });
    }
    ...
    public void onNewBitrateRtmp(final long bitrate) {
        runOnUiThread(() -> tvBitrate.setText(bitrate + " bps"));
    }
